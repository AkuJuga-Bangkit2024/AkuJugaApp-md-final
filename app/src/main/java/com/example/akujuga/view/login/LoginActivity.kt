...
class LoginActivity : AppCompatActivity() {
    ...
    private fun signIn() {
        ...
        val googleIdOption = GetGoogleIdOption.Builder()
            ...
            .setServerClientId(getString(R.string.default_web_client_id)) //from https://console.firebase.google.com/project/firebaseProjectName/authentication/providers
            .build()
